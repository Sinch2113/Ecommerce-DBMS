 ...
 * @author sinch
 */
public class Electronics_Update extends javax.swing.JFrame {

    /**
     * Creates new form Electronics_Update
     */
    public Electronics_Update() {
        initComponents();
        setSize(500,530);
    }
    ...
    private void initComponents() {
        ...
        jButton1.setBounds(382, 447, 95, 39);
        ...
        jButton2.setBounds(250, 447, 105, 39);
...
String sql="update Products set pid=?,prod_name=?,price=?,colour=?,size=?,quantity_avail=?,sid=? where category='electronics';";
        try{  
		Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3306/miniproject","root","root");  
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Electronics_Update.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
